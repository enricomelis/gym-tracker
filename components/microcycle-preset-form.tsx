...
export default function MicrocyclePresetForm({
  ...
  const handleSave = () => {
    ...
    if (sessions.length === 0) {
      toast({
        title: "Sessioni obbligatorie",
        description: "Aggiungi almeno una sessione al microciclo.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (validSessions.length === 0) {
      toast({
        title: "Sessioni obbligatorie",
        description:
          "Almeno una sessione deve avere un preset di allenamento selezionato.",
        variant: "destructive",
      });
      return;
    }
        ...
        {sessions.length === 0 && (
          <div className="rounded-lg border-2 border-dashed border-muted-foreground/25 p-6 text-center">
            <p className="text-sm text-muted-foreground">
              Nessuna sessione aggiunta. Clicca "Aggiungi Sessione" per
              iniziare.
            </p>
          </div>
        )}
