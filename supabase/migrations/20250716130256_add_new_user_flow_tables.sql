...
CREATE TABLE microcycles_presets (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    name TEXT NOT NULL,
    allenamento_1 UUID REFERENCES daily_routine_presets(id),
    allenamento_2 UUID REFERENCES daily_routine_presets(id),
    allenamento_3 UUID REFERENCES daily_routine_presets(id),
    allenamento_4 UUID REFERENCES daily_routine_presets(id),
    allenamento_5 UUID REFERENCES daily_routine_presets(id),
    allenamento_6 UUID REFERENCES daily_routine_presets(id),
    allenamento_7 UUID REFERENCES daily_routine_presets(id),
